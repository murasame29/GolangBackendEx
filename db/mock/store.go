...
// Source: github.com/murasame29/GolangBackendEx/db/sqlc (interfaces: Store)
...
// CreaetEntry mocks base method.
func (m *MockStore) CreaetEntry(arg0 context.Context, arg1 db.CreaetEntryParams) (db.Entries, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreaetEntry", arg0, arg1)
	ret0, _ := ret[0].(db.Entries)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreaetEntry indicates an expected call of CreaetEntry.
func (mr *MockStoreMockRecorder) CreaetEntry(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreaetEntry", reflect.TypeOf((*MockStore)(nil).CreaetEntry), arg0, arg1)
}
