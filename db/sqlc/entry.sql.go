...
const creaetEntry = `-- name: CreaetEntry :one
INSERT INTO entries (
    account_id,
    amount
)VALUES(
...
type CreaetEntryParams struct {
	AccountID int64 `json:"account_id"`
	Amount    int64 `json:"amount"`
}

func (q *Queries) CreaetEntry(ctx context.Context, arg CreaetEntryParams) (Entries, error) {
	row := q.db.QueryRowContext(ctx, creaetEntry, arg.AccountID, arg.Amount)
	var i Entries
	err := row.Scan(
		&i.ID,
		&i.AccountID,
